...
function MenuBar() {
    ...
    return (
        <div className="w-screen flex flex-row flex-nowrap justify-between items-center bg-black text-gray-50 cursor-default select-none">
            ...
            <div className="flex">
                {/* Battery */}
                <div tabIndex="0" className={`${menuBarItemClassName} hidden sm:block`}>
                ...
                {/* Control Centre */}
                <div tabIndex="0" className={`${menuBarItemClassName} block sm:hidden`} onFocus={() => setControlCentre(true)} onBlur={() => setControlCentre(false)}>
