...
function MenuBar() {
    const [controlCentre, setControlCentre] = useState({
        visible: false,
        focus: false
    });
        ...
        <div className="w-screen px-2 flex flex-row flex-nowrap justify-between items-center bg-black text-gray-50 cursor-default select-none">
            ...
            <div className="flex">
                ...
                <div tabIndex="0" className={menuBarItemClassName} 
                    ...
                    // subsequent click after onFocus will modify the visibility of the control centre
                    onClick={() => controlCentre.focus ? setControlCentre({visible: controlCentre.visible, focus: false}) : setControlCentre({visible: !controlCentre.visible, focus: false})}
                    >
